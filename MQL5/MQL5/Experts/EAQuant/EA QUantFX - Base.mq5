...
input int                  TakeProfit              = 40;              // Take profit (pips)  
//+------------------------------------------------------------------+
...
input double               InpTraillingStep        = 20.0;           // Trailing distance (pts) 
input double               InpTraliingStart        = 6.0;            // Trailing start (pts)
//+------------------------------------------------------------------+
...
input int                  TimeStart               = 2;              // Time start  
input int                  TimeEnd                 = 19;             // Time end
...
{ 
   ...
   datetime candle=iTime(_Symbol,_Period,0);
