...
#resource "\\Indicators\\ALX Indicadores\\ALXMarketCycle.ex5"
//#resource "\\Indicators\\ALX Indicadores\\balance_of_power.ex5"
...
//--- save the minimum lot of the transaction to be performed
   lot_size=lot; //SymbolInfoDouble(my_symbol,SYMBOL_VOLUME_MIN);
//--- apply the indicator and get its handle
   iRSI_handle=iCustom(_Symbol,Period(),"::Indicators\\ALX Indicadores\\ALXMarketCycle.ex5",20,3,0.15,-0.15);
