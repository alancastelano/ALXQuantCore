         ...
         if(InpTakeProfit01!=0)
            {
               ...
               m_trade.Buy(lot1,m_symbol.Name(),m_symbol.Ask(),sl,tp1);
               //m_trade.BuyStop(lot1,m_symbol.Ask(),m_symbol.Name(),sl,tp1,ORDER_TIME_GTC,0,"");
            } 
         ...
         if(InpTakeProfit02!=0)
            {
               ...
               m_trade.Buy(lot2,m_symbol.Name(),m_symbol.Ask(),sl,tp2);
               //m_trade.BuyStop(lot2,m_symbol.Ask(),m_symbol.Name(),sl,tp2,ORDER_TIME_GTC,0,"");
            } 
         ...
         if(InpTakeProfit03!=0)
            {
               ...
               m_trade.Buy(lot3,m_symbol.Name(),m_symbol.Ask(),sl,tp3);
               //m_trade.BuyStop(lot3,m_symbol.Ask(),m_symbol.Name(),sl,tp3,ORDER_TIME_GTC,0,"");
            } 
         ...
         if(InpTakeProfit01!=0)
            {
               ...
               m_trade.Sell(lot1,m_symbol.Name(),m_symbol.Bid(),sl,tp1);   
               //m_trade.SellStop(lot1,price,m_symbol.Name(),sl,tp1,ORDER_TIME_GTC,0,"");
            } 
         ...
         if(InpTakeProfit02!=0)
            {
               ...
               m_trade.Sell(lot2,m_symbol.Name(),m_symbol.Bid(),sl,tp2);   
               //m_trade.SellStop(lot2,price,m_symbol.Name(),sl,tp2,ORDER_TIME_GTC,0,"");
            } 
         ...
         if(InpTakeProfit03!=0)
            {
               ...
               m_trade.Sell(lot3,m_symbol.Name(),m_symbol.Bid(),sl,tp3);   
               //m_trade.SellStop(lot3,price,m_symbol.Name(),sl,tp3,ORDER_TIME_GTC,0,"");
            } 
