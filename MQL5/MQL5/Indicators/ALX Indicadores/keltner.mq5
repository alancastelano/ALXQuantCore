...
#property indicator_color1  clrOldLace,clrOldLace //clrDarkGray,clrDarkGray
#property indicator_style1  STYLE_SOLID
#property indicator_width1  1

#property indicator_label2  "Upper band"
#property indicator_type2   DRAW_LINE
#property indicator_color2  clrRed; //clrRed; //C'216,237,243'
#property indicator_style2  STYLE_SOLID
#property indicator_width2  1

#property indicator_label3  "Lower band"
#property indicator_type3   DRAW_LINE
#property indicator_color3  clrDodgerBlue; //clrDodgerBlue; //clrMistyRose
#property indicator_style3  STYLE_SOLID
#property indicator_width3  1

#property indicator_label4  "Keltner MA trend"
#property indicator_type4   DRAW_COLOR_BARS
#property indicator_color4  clrOldLace,clrOldLace //clrDarkGray,clrDarkGray
...
input color              MaColorUp       = clrDarkGray;        // Color for slope up
input color              MaColorDown     = clrDarkGray;        // Color for slope down
