...
#property indicator_color2  clrGold; //C'216,237,243'
#property indicator_style2  STYLE_SOLID
#property indicator_width2  1

#property indicator_label3  "Lower band"
#property indicator_type3   DRAW_LINE
#property indicator_color3  clrGold; //clrMistyRose
...
enMaModes          MAMethod        = ma_Expo;      // Moving average type
enMaVisble         MAVisible       = mv_Visible;     // Midlle line visible ?
enPrices           Price           = pr_typical;     // Moving average price 
color              MaColorUp       = clrGold;        // Color for slope up
color              MaColorDown     = clrGold;        // Color for slope down
enAtrMode          AtrMode         = atr_Atr;        // Range calculating mode 
enCandleMode       ViewBars        = cm_None;        // View bars as :
