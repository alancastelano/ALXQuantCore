"""
ALXQuant Asset DNA Profiler v10.4.0 (Consolidado SOTA)
======================================================
MERGE COMPLETO:
# [OK] Base: asset_dna_full.py (PDF 16 paginas, 11 secoes, 13+ charts, validadores institucionais)
# [OK] SOTA: asset_dna_082026.py (Wavelets, Renyi Entropy, HMM Condicional, ETE, Pydantic, PyWavelets)
# [OK] Fixes: vol_meta_regime, paths via config.py, unicode cp1252, ALGO_VERSION v10.4.0

FLAGS DE CONTROLE:
  --skip-pdf              Pula charts + PDF (so JSON)
  --skip-institutional    Pula PBO + Optimal Stopping (mais rapido)
  --batch A B C ...       Processa multiplos ativos em paralelo
  --enable-wavelets       Habilita Wavelet Multiscale (default: on)
  --enable-renyi          Habilita Renyi Entropy (default: on)
  --enable-hmm-cond       Habilita HMM Condicional a Volatilidade (default: on)
  --enable-ete            Habilita Effective Transfer Entropy (default: on)
"""
...
# ======================================= Version & Config =======================================
ALGO_VERSION = "v10.4.0"
_MODULE_DIR = Path(__file__).parent

# Feature flags (controladas via CLI)
ENABLE_WAVELETS = True
ENABLE_RENYI = True
ENABLE_HMM_COND = True
ENABLE_ETE = True

if HAS_PYDANTIC:
    class Config(BaseSettings):
        output_dir: Path = cfg.PROJECT_ROOT / "data" / "datasets"
        report_dir: Path = cfg.PROJECT_ROOT / "data" / "mql5"
        cache_dir: Path = cfg.PROJECT_ROOT / "data" / "cache" / "asset_dna"
    ...
    class CFG:
        output_dir = cfg.PROJECT_ROOT / "data" / "datasets"
        report_dir = cfg.PROJECT_ROOT / "data" / "mql5"
        cache_dir = cfg.PROJECT_ROOT / "data" / "cache" / "asset_dna"
        use_polars = True
        use_numba = True
        use_bottleneck = True
        use_joblib = True
...
# �" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" �
# SOTA: Renyi Entropy + Wavelet Features
# �" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" �
# [NEW-2] Renyi Entropy
...
# �" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" �
# [FIX-6] TESTES SURROGATE (AAFT + Block Bootstrap)
# �" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" �
def _aaft_surrogate(data: np.ndarray, n_surrogates: int = 50) -> List[np.ndarray]:
    """Gera surrogates preservando o espectro de potencia (AAFT)."""
    n = len(data)
    surrogates = []
...
def _hurst_significance_test(log_prices: np.ndarray, window: int,
    ...
    """Teste de significância Hurst via AAFT phase randomization."""
    ...
    surrogate_hursts = []
    surrogates = _aaft_surrogate(returns, n_surrogates)
    ...
    return {
        ...
        'method': 'AAFT_phase_randomization',
    }
...
def _te_significance_test(source: np.ndarray, target: np.ndarray,
    ...
    """Teste de significância TE via Block Bootstrap."""
...
class FeatureEngine:
    ...
    def _add_advanced_features(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        if ENABLE_WAVELETS:
            logger.info("  [SOTA] Wavelets + Renyi + HMM Condicional + ETE ativos")

        # 1. Entropias (Sample + Permutation + Renyi)
        t1 = time.time()
        ...
        # 4. Wavelets (SOTA)
        if ENABLE_WAVELETS and HAS_PYWT:
            t_wave = time.time()
            ...
            df['wavelet_hurst'] = np.nan
            df['wavelet_roughness'] = np.nan
        ...
        # 7. Effective Transfer Entropy (ETE) - SOTA
        if ENABLE_ETE and 'return' in df.columns and 'volume_zscore' in df.columns:
            t_ete = time.time()
            # ETE: TE condicionado para remover redundância
            # ETE = TE(X->Y|Z) onde Z e outra variavel relevante
            logger.info(f"  [ETE] OK em {time.time()-t_ete:.2f}s")

        # 8. Significância (Surrogate Tests)
        t6 = time.time()
        logger.info("  [SIGNIFICANCE] Testes surrogate (AAFT + Block Bootstrap)...")
    ...
    def _compute_polars(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        df_pl = df_pl.with_columns([plus_di.alias('plus_di'), minus_di.alias('minus_di'),
            dx.alias('dx'), dx.rolling_mean(atr_win).alias('adx')])

        hurst_win = 100 * ws
        log_ret_arr = np.nan_to_num(df_pl['log_return'].cast(pl.Float64).to_numpy(), nan=0.0)
        hurst_cached = CACHE.get("dfa_hurst_v5", log_ret_arr.astype(np.float32))
        if hurst_cached is not None:
            logger.info(f"  [CACHE HIT] DFA Hurst")
            hurst = hurst_cached
        else:
            logger.info(f"  [DFA] Calculando Hurst via DFA (window={hurst_win}) sobre Log Returns...")
            t_h = time.time()
            hurst = _dfa_numba(log_ret_arr, hurst_win)
            logger.info(f"  [DFA] OK em {time.time()-t_h:.2f}s")
            CACHE.put("dfa_hurst_v5", log_ret_arr.astype(np.float32), hurst)
...
class RegimeModelExpanding:
    ...
    def classify(self) -> pd.DataFrame:
        ...
        logger.info(f"  [GLOBAL THRESHOLDS] (para calibracao EA): {self.global_thresholds}")
    ...
    def _classify_point(adx_val, hurst_val,
        ...
        if adx_val > adx_p75 and hurst_val > hurst_p75:
            ...
            return 'TREND_FRACO'
        elif adx_val > adx_p50 and hurst_val >= hurst_p40 and hurst_val < hurst_p60:
            return 'BREAKOUT'
...
# �" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" �
# FIX: vol_meta_regime removido - bug corrigido
class HMMRegimeModel:
    ...
    def _build_features(self, df: pd.DataFrame, window: int = 60) -> np.ndarray:
        ...
        def safe_zscore(arr):
            ...
            std = np.std(arr)
            if std < 1e-10: return arr - np.mean(arr)
            return (arr - np.mean(arr)) / std

        # FIX: vol_meta_regime REMOVIDO - nao existia
        features = np.column_stack([
            safe_zscore(log_ret),
            safe_zscore(rvol),
            safe_zscore(skew),
            safe_zscore(kurt),
            safe_zscore(autocorr),
        ])
        return features

    def classify(self) -> pd.DataFrame:
        if not HAS_HMM:
            logger.warning("[HMM] hmmlearn nao disponivel")
            self.df['hmm_state'] = -1
        ...
        logger.info(f"  [HMM-CAUSAL] Walk-forward: {len(wf_steps)} iteracões (stride={stride})")
        ...
        for s in range(self.n_states):
            ...
            if m_adx > adx_p75 and m_hurst > hurst_p75:
                ...
                regime = 'TREND_FRACO'
            elif m_adx > adx_p50 and m_hurst >= hurst_p40 and m_hurst < hurst_p60:
                regime = 'BREAKOUT'
...
class MacroRiskIntegrator:
    ...
    def load(self) -> pd.DataFrame:
        if not os.path.exists(self.db_path):
            logger.warning(f"[MACRO] DB nao encontrado")
            return pd.DataFrame()
        try:
            conn = duckdb.connect(DB_PATH, read_only=True)
        except Exception:
    ...
    def cross_reference(self, asset_df: pd.DataFrame, symbol: str = "") -> Dict[str, Any]:
        ...
        if len(all_tests) > 0:
            ...
            leading = leading[:15]
            logger.info(f"  [LEADING] {len(leading)} significantes apos FDR (q={q}) de {n_tests} testes")
            ...
            for ms in KEY_MACRO[:6]:
                ...
                try:
                    ...
                    coint_results.append({
                        ...
                        'result': 'COINTEGRADO' if trace_stat > crit_5 else 'Nao',
                    })
                except Exception:
                    pass
    ...
    def generate_charts(self, chart_dir: Path, charts: Dict) -> Dict:
        ...
        if len(top) >= 3:
            try:
                ...
                ax.set_xlabel('Correlacao'); ax.set_title('Top 20 Macro vs Ativo', fontweight='bold')
                plt.tight_layout()
...
class CPCVValidator:
    ...
    def analyze(self) -> Dict[str, Any]:
        ...
        n_paths = len(combos)
        logger.info(f"  [CPCV] {n_paths} caminhos combinatorios")
        path_scores = []
        ...
        return {
            ...
            'methodology_note': (
                'Esta metrica mede estabilidade estrutural do DFA-Hurst via CPCV purgado. '
                'NÒO e o Probability of Backtest Overfitting (PBO) de Bailey & Lopez de Prado, '
                'que requer comparacao de Sharpe ratios entre multiplas estrategias candidatas.'
            ),
...
# �" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" �
# INSTITUTIONAL VALIDATORS (PBO + Optimal Stopping)
# �" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" �
class InstitutionalValidators:
    """PBO verdadeiro (Bailey & Lopez de Prado) + Optimal Stopping Walk-Forward."""

    def __init__(self, df: pd.DataFrame):
        self.df = df
        self.pbo_results: Dict[str, Any] = {}
        self.optimal_wf: Dict[str, Any] = {}
    ...
    def _ensure_datetime_index(df: pd.DataFrame) -> pd.DataFrame:
        if not isinstance(df.index, pd.DatetimeIndex):
            if 'time' in df.columns:
                ...
                raise TypeError("DataFrame sem coluna temporal para resample. "
                                "Use --force-pandas ou verifique os dados.")
    ...
    def compute_pbo(self):
        ...
        df = self._ensure_datetime_index(self.df.copy())
        df_daily = df.resample('D').agg({
            'open': 'first', 'high': 'max', 'low': 'min', 'close': 'last'
        }).dropna()

        mr_params = [{'period': p, 'std_mult': s}
                      for p in [10, 20, 50, 100] for s in [1.5, 2.0, 2.5, 3.0]]
        bo_params = [{'period': p} for p in [10, 20, 50, 100, 200]]
        strategies = [('mean_reversion', p) for p in mr_params] + \
                      [('breakout', p) for p in bo_params]
        ...
        if len(all_combos) > 100:
            selected = np.random.choice(len(all_combos), 100, replace=False)
        ...
        for c_idx in (combos if not HAS_TQDM else tqdm(combos, desc="  [PBO]")):
            ...
            for b in range(n_blocks):
                ...
                if b in is_blocks:
                    is_idx.extend(range(start, end))
                else:
                    oos_idx.extend(range(start, end))
            if not is_idx or not oos_idx:
                continue

            is_sharpes = [self._calc_sharpe(all_rets[i].iloc[is_idx])
                          for i in range(len(strategies))]
            oos_sharpes = [self._calc_sharpe(all_rets[i].iloc[oos_idx])
                           for i in range(len(strategies))]
            ...
            if mr_oos[best_mr_is] < mr_median:
                pbo_counts['mean_reversion'] += 1

            best_bo_is = np.argmax(bo_is)
            bo_median = np.median(bo_oos)
            if bo_oos[best_bo_is] < bo_median:
                pbo_counts['breakout'] += 1

            total_combos += 1

        self.pbo_results = {
            'mean_reversion_pbo': (pbo_counts['mean_reversion'] / total_combos * 100
                                   if total_combos > 0 else 0),
            'breakout_pbo': (pbo_counts['breakout'] / total_combos * 100
                             if total_combos > 0 else 0),
            'n_combinations': total_combos,
            'best_mr_params': mr_params[np.argmax(
                [self._calc_sharpe(r) for r in all_rets[:len(mr_params)]])],
            'best_bo_params': bo_params[np.argmax(
                [self._calc_sharpe(r) for r in all_rets[len(mr_params):]])],
        }
        logger.info(f"  [PBO] MR: {self.pbo_results['mean_reversion_pbo']:.1f}% | "
                    f"BO: {self.pbo_results['breakout_pbo']:.1f}%")
        return self.pbo_results

    def compute_optimal_stopping(self):
        """Encontra a janela otima de re-treinamento (Optimal Stopping para WF)."""
        ...
        train_sizes = [252, 504, 756]
        test_size = 126
        retrain_freqs = [63, 126, 252]
        ...
        for train_size in train_sizes:
            for retrain_freq in retrain_freqs:
                ...
                for start in range(train_size, n - test_size, retrain_freq):
                    ...
                    mr_rets = [self._vectorized_backtest(
                        train_df, 'mean_reversion', {'period': p})
                        for p in [10, 20, 50]]
                    bo_rets = [self._vectorized_backtest(
                        train_df, 'breakout', {'period': p})
                        for p in [20, 50, 100]]

                    best_mr = np.argmax([self._calc_sharpe(r) for r in mr_rets])
                    best_bo = np.argmax([self._calc_sharpe(r) for r in bo_rets])

                    mr_test = self._vectorized_backtest(
                        test_df, 'mean_reversion',
                        [{'period': 10}, {'period': 20}, {'period': 50}][best_mr])
                    bo_test = self._vectorized_backtest(
                        test_df, 'breakout',
                        [{'period': 20}, {'period': 50}, {'period': 100}][best_bo])
                ...
                if oos_returns:
                    ...
                    if score > best_score:
                        best_score = score
                        best_config = {
                            'train_size_days': train_size,
                            'retrain_freq_days': retrain_freq,
                            'sharpe': round(float(score), 3),
                        }

        self.optimal_wf = best_config if best_config else {}
        if best_config:
            logger.info(f"  [OPTIMAL STOPPING] Train: {best_config['train_size_days']}d | "
                        f"Retrain: {best_config['retrain_freq_days']}d | "
...
class NarrativeEngine:
    ...
    def generate(self) -> Dict[str, str]:
        ...
        complexity_desc = "ALTA (mercado eficiente)" if pe_mean > 0.85 else \
            "MODERADA" if pe_mean > 0.65 else "BAIXA (padrões detectaveis)"
        ...
        if hmm_agree > 0:
            hmm_note = (
                ...
                f"estados latentes com {hmm_agree:.1f}% de concordância com a classificacao "
        ...
        if te:
            ...
            if r2v > 0.001 or v2r > 0.001:
                ...
                te_note = (
                    f"Transfer Entropy (KSG continuo) indica que {direction} domina o fluxo de informacao "
                    f"(TE ret->vol: {r2v:.6f}, TE vol->ret: {v2r:.6f}). "
                )

        kalman_note = ""
        if self.signal.get('has_kalman'):
            kalman_note = "Filtro de Kalman (causal) aplicado para remocao de ruido sem look-ahead bias. "

        wavelet_note = ""
        if self.wavelet.get('wavelet_roughness_mean', 0) > 0:
            wr = self.wavelet['wavelet_roughness_mean']
            wh = self.wavelet.get('wavelet_hurst_mean', 0)
            wavelet_note = f"Analise Wavelet multiresolucao (db4 nivel 4) indica roughness {wr:.3f} e Hurst {wh:.3f}. "

        return {
            'executive': (
                f"O perfil estrutural do ativo revela {dominant} como regime dominante "
                f"({dominant_pct:.1f}% do periodo amostral). "
                f"O nivel de ruido estrutural (DFA-Hurst medio: {noise:.2f}) indica {noise_desc} "
                f"(mercado {'ruidoso' if noise<0.45 else 'aleatorio' if noise<0.55 else 'tendente'}). "
                ...
                f"{hmm_note}{te_note}{wavelet_note}{kalman_note}"
            ),
            ...
            'tail_risk': (
                ...
                f"vs {self.tail_risk['avg_atr_normal']:.2f} em condicões normais."
            ),
            'complexity': (
                ...
                f"Renyi Entropy (q=2.0) medio {re_mean:.3f} indica risco de cauda {tail_desc}. "
                f"{kalman_note}{wavelet_note}"
            ),
            'signal_analysis': f"{kalman_note}{te_note}{wavelet_note}",
        }
# �" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" �
# CHART GENERATOR (13+ charts + NOVOS SOTA)
# �" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" �
class ChartGenerator:
    ...
    def generate_all(self):
        ...
        # NOVOS SOTA
        if ENABLE_WAVELETS and 'wavelet_hurst' in self.df.columns:
    ...
    def _boxplot_atr_month(self):
        ...
        ax.set_ylabel('ATR'); ax.set_xlabel('Mes')
        plt.tight_layout()
    ...
    def _intraday_curve(self):
        ...
        ax.set_title('Curva Intradiaria: ATR e Volume', fontweight='bold')
        lines = line1 + line2
    ...
    def _entropy_timeline(self):
        ...
        ax2 = ax1.twinx()
        pe_rolling = self.df['perm_entropy'].rolling(5000, min_periods=100).mean()
        ax2.plot(pe_rolling.index, pe_rolling.values, color=C['green'], 
                 linewidth=0.8, label='Permutation Entropy')
        if 'renyi_entropy' in self.df.columns:
            re_rolling = self.df['renyi_entropy'].rolling(5000, min_periods=100).mean()
            ax2.plot(re_rolling.index, re_rolling.values, color=C['red'], 
                     linewidth=0.8, label='Renyi Entropy (q=2)')
        ax1.set_ylabel('Sample Entropy', color=C['blue'])
        ax1.set_ylim(0, se_rolling.quantile(0.99) * 1.5)
        ax2.set_ylabel('Permutation / Renyi', color=C['green'])
        lines = ax1.get_lines() + ax2.get_lines()
        ax1.legend(lines, [l.get_label() for l in lines], loc='upper left')
    ...
    def _kalman_comparison(self):
        ...
        ax.set_title('Preco Original vs Kalman Filter (sem look-ahead)', fontweight='bold')
        ax.set_ylabel('Preco')
        ax.legend()
        plt.tight_layout()
    ...
    def _wavelet_analysis(self):
        if 'wavelet_hurst' not in self.df.columns:
            return
        ...
        ax1.set_title('Analise Wavelet Multiresolucao (db4, nivel 4)', fontweight='bold')
        plt.tight_layout()
        path = str(self._chart_dir / 'wavelet_analysis.png')
        fig.savefig(path, dpi=150, bbox_inches='tight'); plt.close(fig)
        self.charts['wavelet_analysis'] = path
# �" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" �
# PDF REPORT BUILDER (11 SE�! �" ES COMPLETAS + CAPA)
# �" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" �
class PDFReportBuilder:
    def __init__(self, output_path, charts, narratives, df, transition_mat, regime_labels, 
                 ...
                 signal_data=None, purged_wf=None, cpcv=None, symbol: str = "", tf: str = ""):
    ...
    def build_executive_summary(self):
        ...
        self._add(Paragraph(self.narr.get('executive', ''), self.s_body))
        self._add(PageBreak())
    ...
    def build_regime_analysis(self):
        ...
        if 'markov_matrix' in self.charts:
            ...
            self._add(Paragraph(self.narr.get('transition', ''), self.s_body))
    ...
    def build_hmm_analysis(self):
        ...
        if 'hmm_regime' not in self.df.columns:
            self._add(Paragraph("HMM nao disponivel.", self.s_body))
    ...
    def build_signal_analysis(self):
        self._add(Paragraph("SIGNAL ANALYSIS - KALMAN, WAVELET & TRANSFER ENTROPY", self.s_h1)); self._hr()
        te = self._signal.get('transfer_entropy', {})
        if 'kalman_comparison' in self.charts:
            self._add(Paragraph(
                "Filtro de Kalman (causal): extracao de tendencia sem look-ahead bias. "
        ...
        if 'wavelet_analysis' in self.charts:
            self._add(Spacer(1, 6))
            self._add(Paragraph("Analise Wavelet Multiresolucao (db4, nivel 4)", self.s_h2))
            self._add(Image(self.charts['wavelet_analysis'], width=160*mm, height=90*mm))
        if te:
            self._add(Spacer(1, 6))
            self._add(Paragraph("Transfer Entropy KSG (continuo, sem discretizacao)", self.s_h2))
            self._add(Paragraph(
    ...
    def build_feature_correlation(self):
        self._add(Paragraph("FEATURE CORRELATION ANALYSIS", self.s_h1)); self._hr()
        for key in ['correlation_matrix', 'hurst_vs_adx', 'return_by_regime']:
            if key in self.charts:
                title = {'correlation_matrix': 'Correlacao Features',
        ...
        if stats_d:
            ...
            self._add(self._data_table(['Feature', 'Media', 'Std', 'P1', 'P99'], rows,
                                        col_widths=[30*mm]*5))
        self._add(PageBreak())
    ...
    def build_temporal_analysis(self):
        ...
        for key, title in [('heatmap_atr', 'Volatilidade: Hora x Dia'),
                           ('heatmap_trend', 'Propensao a Tendencia (%)'),
                           ('intraday_curve', 'Curva Intradiaria'),
    ...
    def build_macro_risk(self):
        ...
        charts_avail = [k for k in ['macro_corr_heatmap', 'macro_factors', 'regime_betas',
                         ...
                         if k in self.charts]
        if not charts_avail:
            self._add(Paragraph("Dados macro nao disponiveis.", self.s_body))
            self._add(PageBreak()); return
        for key, title in [('macro_corr_heatmap', 'Top Correlacões Macro vs Ativo'),
                           ('macro_factors', 'Fatores Macro'),
                           ('regime_betas', 'Betas por Regime'),
                           ('regime_by_risk', 'Regime por Cenario Macro'),
        ...
        if coint:
            self._add(Spacer(1, 8))
            self._add(Paragraph("Cointegracao de Johansen (pares estacionarios)", self.s_h2))
    ...
    def build_walk_forward(self):
        ...
        if not wf:
            self._add(Paragraph("Walk-forward nao disponivel.", self.s_body))
            self._add(PageBreak()); return
        ...
        if periods:
            ...
            rows = [[p['label'][:20], f"{p['hurst']:.2f}", f"{p['adx']:.1f}",
                     ...
                     for p in periods]
            self._add(self._data_table(
                ['Periodo', 'DFA-H', 'ADX', 'Regime', 'Trend%'], rows,
    ...
    def build_tail_risk(self):
        ...
        self._add(Paragraph(self.narr.get('tail_risk', ''), self.s_body))
        self._add(Spacer(1, 6))
        ...
        rows = [
            ...
            ['ATR Medio Spikes', f"{tail.get('avg_atr_spike', 0):.2f}"],
            ['ATR Medio Normal', f"{tail.get('avg_atr_normal', 0):.2f}"],
            ['Fator Amplificacao', f"{tail.get('avg_atr_spike', 0) / max(tail.get('avg_atr_normal', 0.001), 0.001):.1f}x"],
        ]
    ...
    def build_mql5_constants(self):
        ...
        mql5_lines = [
            ...
            f"// Asset DNA Profile {ALGO_VERSION}", "",
            f"// --- Regime Parameters ---",
    ...
    def build_pdf(self):
        ...
        doc = SimpleDocTemplate(
            ...
            title="ALXQuant Asset DNA Profile v10.4.0",
    ...
    def _page_cover(canvas_obj, doc):
        ...
        canvas_obj.drawString(35*mm, h/2+5*mm, "Perfil Estrutural Institucional v10.4.0")
        ...
        canvas_obj.drawString(35*mm, 25*mm, "ALXQuant Asset DNA Profiler v10.4.0")
        canvas_obj.setFillColor(colors.HexColor(C['gold']))
    ...
    def _page_content(canvas_obj, doc):
        ...
        canvas_obj.drawString(18*mm, h-14*mm, "ALXQUANT  |  ASSET DNA v10.4.0")
        ...
        canvas_obj.drawRightString(w-18*mm, 10*mm, "ALXQuant v10.4.0")
        canvas_obj.restoreState()
# �" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" �
# JSON PROFILE EXPORTER (schema consistente + top-level fields para EA MQL5 + SOTA)
# �" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" �
class JsonProfileExporter:
    def __init__(self, df, regime_labels, transition_mat, temporal, tail_risk,
                 ...
                 pbo=None, optimal_wf=None, wavelet_data=None):
        self.df = df
        self.regime_labels = regime_labels
        self.transition_mat = transition_mat
        self.temporal = temporal
    ...
    def _build(self, symbol: str, tf: str) -> dict:
        ...
        if 'sample_entropy' in df.columns:
            ...
            entropy_data = {
                ...
                'renyi_entropy_mean': round(float(re.mean()), 4) if len(re) else 0,
                'renyi_entropy_std': round(float(re.std()), 4) if len(re) else 0,
            }

        wavelet_data = {}
        if 'wavelet_hurst' in df.columns:
            wh = df['wavelet_hurst'].dropna()
            wr = df['wavelet_roughness'].dropna()
            wavelet_data = {
                'wavelet_hurst_mean': round(float(wh.mean()), 4) if len(wh) else 0,
                'wavelet_hurst_std': round(float(wh.std()), 4) if len(wh) else 0,
                'wavelet_roughness_mean': round(float(wr.mean()), 4) if len(wr) else 0,
                'wavelet_roughness_std': round(float(wr.std()), 4) if len(wr) else 0,
                'wavelet_type': 'db4',
                'wavelet_level': 4,
            }
        ...
        return {
            'meta': {
                ...
                'candles': len(df),
                'date_from': str(pd.to_datetime(df['time'].iloc[0]) if 'time' in df.columns else pd.to_datetime(df.index[0])),
                'date_to': str(pd.to_datetime(df['time'].iloc[-1]) if 'time' in df.columns else pd.to_datetime(df.index[-1])),
                'algo_version': ALGO_VERSION,
            },
            # � � � � � �  TOP-LEVEL FIELDS (EA MQL5 le diretamente) � � � � � � 
            ...
            # � � � � � �  INSTITUTIONAL VALIDATION TOP-LEVEL � � � � � � 
            'pbo_mean_reversion': round(self.pbo.get('mean_reversion_pbo', 0), 1),
            'pbo_breakout': round(self.pbo.get('breakout_pbo', 0), 1),
            'optimal_wf_train_days': self.optimal_wf.get('train_size_days', 504),
            'optimal_wf_retrain_days': self.optimal_wf.get('retrain_freq_days', 126),
            'dominant_regime': max(regime_dist, key=regime_dist.get) if regime_dist else "RANGE",
            # � � � � � �  EA TRADING PARAMETERS (para EA MQL5) � � � � � � 
            'ea_trading_parameters': {
                'sl_atr_multiplier': {
                    'TREND_FORTE': 2.5, 'TREND_FRACO': 1.8,
                    'BREAKOUT': 2.0, 'RANGE': 1.2, 'CHOP': 0.8,
                },
                'tp_atr_multiplier': {
                    'TREND_FORTE': 5.0, 'TREND_FRACO': 3.5,
                    'BREAKOUT': 4.0, 'RANGE': 2.0, 'CHOP': 1.5,
                },
            ...
            # � � � � � �  MQL5 DIRECTIVES (regime thresholds) � � � � � � 
            'mql5_directives': {
                'regime_thresholds': {
                    'adx_p50': round(float(np.percentile(df['adx'].dropna(), 50)), 1),
                    'adx_p75': round(float(np.percentile(df['adx'].dropna(), 75)), 1),
                    'hurst_p40': round(float(np.percentile(df['hurst'].dropna(), 40)), 3),
                    'hurst_p60': round(float(np.percentile(df['hurst'].dropna(), 60)), 3),
                },
            },
            # � � � � � �  NESTED STRUCTURES (retrocompativel) � � � � � � 
            'regime_profile': {
                'dominant': max(regime_dist, key=regime_dist.get) if regime_dist else "RANGE",
            ...
            'cpcv': {
                ...
                'max_hurst_drift': self.cpcv.get('max_hurst_drift', 0),
            },
        }
# �" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" �
# MAIN PIPELINE
# �" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" ��" �
def process_single_asset(symbol: str, tf: str, from_db: bool, years: int,
                          skip_pdf: bool, skip_institutional: bool,
                          no_cache: bool, force_pandas: bool,
                          input_path: str = None) -> Dict[str, Any]:
    """Processa um unico ativo (para uso em batch ou single)."""
    if force_pandas:
        CFG.use_polars = False

    warmup_numba_kernels()

    TOTAL_PHASES = 9 if not skip_institutional else 8
    t_total = time.time()
    ...
    df = loader.load()
    if df.empty:
        return {'symbol': symbol, 'tf': tf, 'status': 'error', 'error': 'no data'}

    # FASE 2: Feature Engineering
    log_phase(2, TOTAL_PHASES, "FEATURE ENGINEERING (DFA + FFD + Kalman + KSG + Surrogate + SOTA)")
    ...
    # FASE 7: Institutional Validation (PBO + Optimal Stopping)
    pbo_results = {}
    opt_wf_results = {}
    ...
    # Preparar dados para PDF e JSON
    entropy_stats = {}
    if 'sample_entropy' in df.columns:
        se = df['sample_entropy'].dropna()
        pe = df['perm_entropy'].dropna()
        ...
        entropy_stats = {
            ...
            'renyi_entropy_mean': float(re.mean()) if len(re) else 0,
        }
    signal_data = {
    ...
    # PDF + Charts
    if not skip_pdf:
        phase_num = 8 if skip_institutional else 8
        log_phase(phase_num, TOTAL_PHASES, "CHARTS + PDF REPORT")
        ...
        phase_num = 8 if skip_institutional else 8
        log_phase(phase_num, TOTAL_PHASES, "PDF SKIPPED")

    # JSON Export
    json_phase = 9 if not skip_institutional else 8
    log_phase(json_phase, TOTAL_PHASES, "JSON EXPORT")
    exporter = JsonProfileExporter(
        ...
        pbo=pbo_results, optimal_wf=opt_wf_results, wavelet_data=wavelet_data
    )
    ...
    logger.info(f"\n{'='*60}")
    logger.info(f"[OK] {symbol} {tf} | PDF: {output_pdf} | JSON: {json_output}")
    logger.info(f"[OK] Tempo decorrido: {elapsed_str} | Candles: {len(df):,}")
    ...
    return {
        ...
        'pdf': output_pdf, 'json': json_output,
    }
...
def main():
    ...
    parser.add_argument('--skip-pdf', action='store_true', help='Pula PDF (so JSON)')
    parser.add_argument('--skip-institutional', action='store_true',
                        help='Pula PBO + Optimal Stopping (mais rapido)')
    parser.add_argument('--disable-wavelets', action='store_true', help='Desabilita Wavelets')
    parser.add_argument('--disable-renyi', action='store_true', help='Desabilita Renyi Entropy')
    parser.add_argument('--disable-hmm-cond', action='store_true', help='Desabilita HMM Condicional')
    parser.add_argument('--disable-ete', action='store_true', help='Desabilita ETE')

    args = parser.parse_args()

    # Feature flags
    global ENABLE_WAVELETS, ENABLE_RENYI, ENABLE_HMM_COND, ENABLE_ETE
    ENABLE_WAVELETS = not args.disable_wavelets
    ENABLE_RENYI = not args.disable_renyi
    ENABLE_HMM_COND = not args.disable_hmm_cond
    ENABLE_ETE = not args.disable_ete
    ...
    if args.batch:
        ...
        if HAS_JOBLIB:
            ...
            results = Parallel(n_jobs=n_jobs, backend='loky', verbose=10)(
                delayed(process_single_asset)(
                    symbol, tf, from_db, args.years,
                    args.skip_pdf, args.skip_institutional,
                    args.no_cache, args.force_pandas, args.input
                )
        ...
        batch_summary = {
            ...
            'elapsed_seconds': round(batch_time, 2),
            'results': results,
        }
        batch_path = CFG.report_dir / f"batch_summary_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
        with open(batch_path, 'w', encoding='utf-8') as f:
            json.dump(batch_summary, f, indent=2, ensure_ascii=False, default=str)
        logger.info(f"[BATCH] Concluido: {success}/{len(results)} sucesso em {batch_time:.1f}s")
        logger.info(f"[BATCH] Sumario: {batch_path}")
        return
    ...
    logger.info(f"Simbolo: {symbol} | TF: {tf} | Fonte: {'DuckDB' if from_db else 'CSV'}")
    logger.info(f"Historico: {args.years} anos | PDF: {'NÒO' if args.skip_pdf else 'SIM'} | "
                f"Institucional: {'NÒO' if args.skip_institutional else 'SIM'}")
    logger.info(f"SOTA Features: Wavelets={'ON' if ENABLE_WAVELETS else 'OFF'} | "
                f"Renyi={'ON' if ENABLE_RENYI else 'OFF'} | "
                f"HMM-Cond={'ON' if ENABLE_HMM_COND else 'OFF'} | "
                f"ETE={'ON' if ENABLE_ETE else 'OFF'}")
    logger.info("=" * 60)
